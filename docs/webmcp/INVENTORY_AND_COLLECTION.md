...
- Shift+D duplicates a selected item without conflicting with browser bookmark shortcuts; Ctrl+D / ⌘D remains supported when the browser delivers it. Ctrl+Z undoes the change. Text fields keep normal typing behavior, and the Duplicate inspector button shows the shortcut.
